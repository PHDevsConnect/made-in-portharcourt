...
## <a name="R"> </a>R
* [RCopy](https://github.com/Jay-kel/Rcopy) - RCopy is a simple class written in PHP that helps with copying and getting the size of remote files **By [@Russell Japheth](https://github.com/Jay-kel)**
## <a name="S"> </a>S
