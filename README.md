...
## <a name="R"> </a>R
* [RCopy](https://github.com/RussellJapheth/Rcopy) - RCopy is a simple class written in PHP that helps with copying and getting the size of remote files. It also supports real-time progress reporting and resumable downloads. **By [@Russell Japheth](http://russell.kingchionline.com/)**
## <a name="S"> </a>S
